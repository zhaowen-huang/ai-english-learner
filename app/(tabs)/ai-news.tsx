...
import { View, Text, FlatList, TouchableOpacity, RefreshControl, ActivityIndicator, StyleSheet, Dimensions, Image } from 'react-native';
...
const categoryColors: Record<string, { bg: string; text: string }> = {
  'AI Technology': { bg: '#E3F2FD', text: '#1976D2' },
  'AI Research': { bg: '#F3E5F5', text: '#7B1FA2' },
  'Autonomous Driving': { bg: '#E8F5E9', text: '#388E3C' },
  'AI Healthcare': { bg: '#FFF3E0', text: '#F57C00' },
  'NLP': { bg: '#FCE4EC', text: '#C2185B' },
  'Machine Learning': { bg: '#E0F7FA', text: '#00838F' },
  'Robotics': { bg: '#FFF8E1', text: '#F9A825' },
  'Computer Vision': { bg: '#E8F5E9', text: '#2E7D32' },
  'AI Ethics': { bg: '#FFEBEE', text: '#C62828' },
};
